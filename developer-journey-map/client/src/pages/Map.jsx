      ...
      <div className="p-3">
        ...
        <div>
          <div className="grid grid-cols-6 grid-row-5">
            <div className="bg-black text-white w-48 text-center py-1 rounded-t-lg">
              STAGE
            </div>
            ...
            <div className="bg-black text-white w-48 text-center py-1">
              GOALS / NEEDS
            </div>
            ...
            <div className="bg-black text-white w-48 text-center py-1 rounded-b-lg">
